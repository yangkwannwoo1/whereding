                                                ...
                                                <tr class="input_area">
                                                    <td class="address" colspan="4">
                                                        <input class="hidden_address w" type="hidden"
                                                            name="wAddress"><!-- 서울특별시 강남구, 서울특별시 영등포구... -->
                                                        지역
                                                        ...
                                                        <span class="minPrice"><input type="number" placeholder="0"
                                                                value="0" name="wMinPrice">만원</span>~&nbsp;
                                                        <span class="maxPrice"><input type="number" placeholder="100"
                                                                value="100" name="wMaxPrice">만원</span>
                                                    </td>
                                                </tr>
                                                <tr class="input_area">
                                                    <td colspan="4">
                                                ...
                                                <tr class="input_area">
                                                    <td class="address" colspan="4">
                                                        <input class="hidden_address s" type="hidden"
                                                            name="sAddress"><!-- 서울특별시 강남구, 서울특별시 영등포구... -->
                                                        지역
                                                        ...
                                                        가격
                                                        <span class="minPrice"><input type="number" placeholder="0"
                                                                value="0" name="sMinPrice">만원</span>~&nbsp;
                                                        <span class="maxPrice"><input type="number" placeholder="100"
                                                                value="100" name="sMaxPrice">만원</span>
                                                    </td>
                                                </tr>
                                                <tr class="input_area">
                                                        ...
                                                        <div class="form-check-inline">
                                                            <label class="form-check-label">
                                                                <input type="checkbox"
                                                                    ...
                                                                    style="margin-right: 0px;" name="sWeek"><span
                                                ...
                                                <tr class="input_area">
                                                    <td class="address" colspan="4">
                                                        <input class="hidden_address d" type="hidden"
                                                            name="dAddress"><!-- 서울특별시 강남구, 서울특별시 영등포구... -->
                                                        지역
                                                        ...
                                                        가격
                                                        <span class="minPrice"><input type="number" placeholder="0"
                                                                value="0" name="dMinPrice">만원</span>~&nbsp;
                                                        <span class="maxPrice"><input type="number" placeholder="100"
                                                                value="100" name="dMaxPrice">만원</span>
                                                    </td>
                                                </tr>
                                                <tr class="input_area">
                                                    <td class="weekendYNArea" colspan="4">
                                                        <div class="form-check-inline">
                                                            <label class="form-check-label">
                                                                <input type="checkbox"
                                                                    class="form-check-input weekendYN"
                                                                    style="margin-right: 0px;" name="dWeek"><span
                                                                    style="vertical-align:10px; width: 120px; border: none; font-size: 17px;">주말영업여부</span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="input_area">
                                                    <td class="address" colspan="4">
                                                        <input class="hidden_address m" type="hidden"
                                                            name="mAddress"><!-- 서울특별시 강남구, 서울특별시 영등포구... -->
                                                        지역
                                                        ...
                                                        가격
                                                        <span class="minPrice"><input type="number" placeholder="0"
                                                                value="0" name="mMinPrice">만원</span>~&nbsp;
                                                        <span class="maxPrice"><input type="number" placeholder="100"
                                                                value="100" name="mMaxPrice">만원</span>
                                                    </td>
                                                </tr>
                                                <tr class="input_area">
                                                    <td class="weekendYNArea" colspan="4">
                                                        <div class="form-check-inline">
                                                            <label class="form-check-label">
                                                                <input type="checkbox"
                                                                    class="form-check-input weekendYN"
                                                                    style="margin-right: 0px;" name="mWeek"><span
                                                                    style="vertical-align:10px; width: 120px; border: none; font-size: 17px;">주말영업여부</span>
                                                            </label>
                                                        </div>
                                                    </td>
