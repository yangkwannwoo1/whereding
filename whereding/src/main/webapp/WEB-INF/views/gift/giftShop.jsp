...
<!-- favicon -->
	<link rel="shortcut icon" type="image/png" href="resources/css/assets/img/favicon.png">
	<!-- google font -->
		...
		<div class="container">
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".strawberry">와인</li>
                            <li data-filter=".berry">쿠킼</li>
                            <li data-filter=".lemon">수건</li>
							<li data-filter=".lemon">몰라</li>
							<li data-filter=".lemon">인직</li>
							<li data-filter=".lemon">도둑</li>
                        </ul>
                    </div>
                </div>
            </div>
			...
			<div class="row product-lists">
        		...
        		<div class="col-lg-4 col-md-6 text-center strawberry">
                		...
                		<h3>${g.giftName}</h3>
                		<p class="product-price"><span>${g.giftContent}</span> </p>
                		<p><fmt:formatNumber value="${g.giftPrice}" type="number" pattern="#,###원" /></p>
                		<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i>상세보기</a>
            		</div>
        		</div>
    		</c:forEach>
</div>
